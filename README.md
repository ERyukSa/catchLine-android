...
- 프로젝트를 체계적으로 진행해보고 싶었습니다.
    ...
    → 이전 프로젝트는 첫 개인 프로젝트로서 제게 정말 의미 있는 경험이었습니다. 하지만 화면,기능,구조,데이터를 즉석으로 추가하며 개발했기 때문에 중간 과정에서 코드를 자주 엎어야 했습니다. 그래서 이제는 그 다음 단계로서 구조에 대해 충분히 고민하는 프로젝트를 하고 싶었습니다.
